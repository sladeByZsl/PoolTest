...
namespace QFramework
{
    public class CreateViewControllerCode : EditorWindow
    {
        ...
        public static void DoCreateCodeFromScene(GameObject gameObject)
        {
            ...
            var panelCodeInfo = new ViewControllerCodeInfo {GameObjectName = generateInfo.name};
            ...
            EditorPrefs.SetString("GENERATE_NAMESPACE", !string.IsNullOrWhiteSpace(generateInfo.Namespace) ? ViewControllerKit.Setting.Namespace : generateInfo.Namespace);
        ...
        static void AddComponent2GameObject()
        {
            ...
            else
            {
               ...
               Debug.Log(type);
                ...
                if (!gameObject)
                {
                    Debug.Log($"上次的 View Controller 生成失败,找不到 GameObject:{gameObjectName}");
                ...
                foreach (var bindInfo in panelCodeInfo.BindInfos)
                {
                    ...
                    var componentName = bindInfo.BindScript.Name.Split('.').Last();
                ...
                if (codeGenerateInfo)
                {
                    ...
                    if (generatePrefab)
                    {
                        ...
                        SaveAndConnectPrefab(genereateFolder, gameObject);
                    }
                }
                else
                {
        ...
        public static UnityEngine.Object SaveAndConnectPrefab(string assetPrefabPath, GameObject gameObject)
        {
